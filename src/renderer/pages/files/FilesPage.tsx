...
const FilesPage: FC = () => {
  ...
  const menuItems = [
    {
      key: FILE_TYPE.DOCUMENT,
      label: t('files.document'),
      icon: <FileIcon size={16} strokeWidth={1.6} className="text-foreground/80" />
    },
    {
      key: FILE_TYPE.IMAGE,
      label: t('files.image'),
      icon: <FileImage size={16} strokeWidth={1.6} className="text-foreground/80" />
    },
    {
      key: FILE_TYPE.TEXT,
      label: t('files.text'),
      icon: <FileTypeIcon size={16} strokeWidth={1.6} className="text-foreground/80" />
    },
    { key: 'all', label: t('files.all'), icon: <FileText size={16} strokeWidth={1.6} className="text-foreground/80" /> }
  ] as const
