    ...
    compoundVariants: [
      {
        size: 'xs',
        loading: true,
        className: 'ml-0.5 size-2.5 data-[state=checked]:translate-x-2.5'
      },
      {
        size: 'sm',
        loading: true,
        className: 'ml-0.5 size-3 data-[state=checked]:translate-x-3'
      },
      {
        size: 'md',
        loading: true,
      ...
      },
      {
        size: 'lg',
        loading: true,
        className: 'ml-0.5 size-4 data-[state=checked]:translate-x-4'
      }
    ]
  }
)
  ...
  return (
    <SwitchPrimitive.Root
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn('bg-control-thumb', switchThumbVariants({ size, loading }), classNames?.thumb)}>
        {loading && (
          <svg
            width="inherit"
            height="inherit"
